...
export default function CommentsPage() {
    ...
    useEffect(() => {
        fetchComments();
    }, [debouncedSearch, selectedStatus, selectedStar, page, pageSize]);
    ...
    const handleSubmit = async (data: Partial<Comment>) => {
        ...
        try {
            ...
            const res = await fetch('/api/comment/admin', {
                ...
                body: JSON.stringify(editingComment ? { ...data, _id: editingComment._id } : data),
            });
                ...
                <div className="space-y-8">
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                        <div className="space-y-1">
                            ...
                            <p className="text-gray-600">Manage and organize your comments</p>
                        </div>
                    </div>
                                ...
                                <TableBody>
                                    {comments.map((comment) => (
                                        <TableRow key={comment._id} className="hover:bg-gray-50 transition-colors">
                                            ...
                                            <TableCell>{comment?.postId?.postTitle}</TableCell>
